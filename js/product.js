$(function () {
    // product gallery
    $('.product-gallery-container').each(function (_, container) {
        ...
        // Swiper containers
        mainSwiperContainer = sliderContainer.find('.swiper-product');
        ...
        // product fancybox
        $().fancybox({
            selector : '.swiper-product .swiper-slide:not(.swiper-slide-duplicate) .product-media-thumbnail',
            backFocus : false,
            loop: true,
            keyboard: true,
            buttons: [
